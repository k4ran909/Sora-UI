...
const VISUALIZER_PROPS = [
  { name: "wordTimings", type: "WordTiming[]", default: "DEFAULT_TIMINGS", description: "Array of words with precision start and end timestamps in seconds." },
  { name: "audioSrc", type: "string", default: "—", description: "URL to a speech audio file. Fallbacks to simulated progress bar playback if omitted." },
  { name: "highlightBg", type: "string", default: "#ffffff", description: "Active background highlight color of the word capsule." },
  { name: "highlightText", type: "string", default: "#09090b", description: "Active text color of the highlighted word." },
  { name: "componentColor", type: "string", default: "var(--card)", description: "Background color of the player container card." },
];

const EXAMPLE_BASIC = `import { AudioTimingVisualizer } from "@/components/ui/audio-timing-visualizer";
...
export function AudioTimingVisualizerDocs() {
  return (
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6">
          <div className="space-y-3">
            <h3 className="text-sm font-semibold text-ink">Basic Synced Playback</h3>
