  ...
  if (example.commands) {
    return (
      <div className="">
        ...
        <div className="w-full bg-black/20 p-2 backdrop-blur-lg rounded-lg mt-2">
          <div className="flex border-b border-white/10 mb-2 w-full gap-2">
            {(["npm", "pnpm", "bun"] as const).map((tab) => (
              <button
                key={tab}
                onClick={() => setActiveTab(tab)}
                className={cn(
                  "px-3 py-1 text-xs font-medium cursor-pointer rounded-t-md transition-colors",
                  activeTab === tab
          ...
          <div className="w-full p-2">
            <CodeBlock
              ...
              code={example.commands[activeTab]}
